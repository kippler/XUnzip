...
struct XWriteStream
{
	...
	BOOL WriteByte(BYTE c) { return Write(&c, 1); }
};
...
public :
	...
	virtual BOOL	Write(LPCVOID lpBuffer, DWORD nNumberOfBytesToWrite) { m_pos += nNumberOfBytesToWrite; m_size = _max(m_pos, m_size); return TRUE; }
